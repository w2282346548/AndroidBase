...
public abstract class ListSupportAdapter<T> extends RecyclerSupportAdapter<T> implements ListAdapter,SpinnerAdapter {
    ...
    public ListSupportAdapter(Context context) {
        super(context);
    }

    public ListSupportAdapter(Context context, List<T> list) {
        super(context, list);
    }
...
//        BaseViewHolder holder = onCreate(convertView, parent, getItemViewType(position));
        BaseViewHolder holder=new BaseViewHolder(createItemView(getContext(),getItemViewType(position)));
